  ...
  return (
    <HeroContainer>
      <HeroContent>
        ...
        <Tagline>We specialize in serving merchants who acquire customers through <strong style={{color: '#34d399'}}>e-commerce platforms</strong>. Our decline recovery technology is optimized for businesses using online stores, digital shopping carts, and web-based transaction flows.</Tagline>
        <CTAButtonGroup>
        ...
        <Highlight>Trusted by e-commerce merchants processing high-volume online orders and digital transactions.</Highlight>
      </HeroContent>
    </HeroContainer>
  );
