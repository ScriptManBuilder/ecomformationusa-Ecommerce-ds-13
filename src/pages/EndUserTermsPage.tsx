      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              We serve only e-commerce clients. These End-User Terms of Service ("End-User Terms") govern your use of services provided by 
              {process.env.REACT_APP_COMPANY_NAME} when you make a purchase through our e-commerce offers.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} provides customer payment assistance services for e-commerce purchases. 
              Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Payment Processing:</strong> Secure processing of payments for products ordered through e-commerce
              </LegalListItem>
              <LegalListItem>
              ...
              <LegalListItem>
                <strong>Customer Service:</strong> Support for questions about your e-commerce order
              </LegalListItem>
              <LegalListItem>
            ...
            <LegalParagraph style={{ marginTop: '1rem' }}>
              We process payments for products you ordered via e-commerce. The products and services are provided 
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              These End-User Terms are governed by the laws of the State of Florida, United States, without regard to 
            ...
            <LegalList>
              ...
              <LegalListItem>
                <strong>Arbitration Location:</strong> Arbitration shall take place in Winter Haven, Florida or remotely by mutual agreement
              </LegalListItem>
              <LegalListItem>
